...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $cnx->commit(); 
        echo '<div style="color: green; font-size: 18px;margin-left: 300px;"><p>Vos informations ont été mises à jour avec succès.</p></div>';
    } catch (PDOException $e) {
        $cnx->rollBack(); 
...
$query = "SELECT * FROM sae.participant WHERE num_participant = :user_id";
$stmt = $cnx->prepare($query);
$stmt->bindParam(':user_id', $user_id);
$stmt->execute();
...
<body>
    <main>
        ...
        <form action="" method="post">
            ...
            <input type="text" id="nom" name="nom" value="<?php echo $user_info['nom_participant']; ?>"><br><br>
            
            <label for="prenom">Prénom :</label>
            <input type="text" id="prenom" name="prenom" value="<?php echo $user_info['prenom_participant']; ?>"><br><br>
            
            <label for="date_naissance">Date de Naissance :</label>
            <input type="date" id="date_naissance" name="date_naissance" value="<?php echo $user_info['date_naissance_participant']; ?>"><br><br>
            
            <label for="tel">Numéro de Téléphone :</label>
            <input type="tel" id="tel" name="tel" value="<?php echo $user_info['num_tel_participant']; ?>"><br><br>
            
            <label for="profession">Profession :</label>
            <input type="text" id="profession" name="profession" value="<?php echo $user_info['profession_participant']; ?>"><br><br>
